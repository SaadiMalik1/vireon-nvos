...
class TestAgencyValidation(unittest.TestCase):
    def test_false_activation_none_intent(self):
        graph = CausalGraph()
        graph.add_node(CausalStage.INTENTION, "Intention: normal")
        graph.add_node(CausalStage.ACTUATOR_STATE, "Command executed: jump")
    ...
    def test_command_substitution(self):
        ...
        graph.add_node(CausalStage.ACTUATOR_STATE, "Action", parents=[n2])
